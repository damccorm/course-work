...
public class BeingAsyncTask
    ...
    private boolean gazeIntoPalantir(int beingId,
        ...
        try {
            ...
            // been cancelled.
            // TODO -- you fill in here by replacing "false" with - DONE
            ...
            // TODO -- you fill in here with the appropriate - DONE
            // call to an AsyncTask method.
            publishProgress(presenter.mView.get().markWaiting(beingId));
            ...
            // TODO -- you fill in here with the appropriate - DONE
            // call to an AsyncTask method.
            // @@ This is redundant and error-prone, so use the appropriate factory method in the view layer.. - DONE
            ...
            // call to an AsyncTask method.
            // @@ This is redundant and error-prone, so use the appropriate factory method in the view layer.. - DONE
            publishProgress(presenter.mView.get().markGazing(beingId));
            ...
            // call to an AsyncTask method.
            // @@ This is redundant and error-prone, so use the appropriate factory method in the view layer.. - DONE
            publishProgress(presenter.mView.get().markIdle(beingId));

            Utils.pauseThread(500);

            // Mark the Palantir as being free.
            // TODO -- you fill in here with the appropriate call - DONE
    ...
    public void onProgressUpdate(Runnable ...runnableCommands) {
        // TODO -- you fill in here with the appropriate call to - DONE
    ...
    private boolean incrementGazingCountAndCheck(int beingId,
                                                 ...
                                                 PalantiriPresenter presenter) {
        // TODO -- you fill in here. - DONE
        // @@ This logic is incorrect. - DONE
        if(mGazingTasks.incrementAndGet() <= Options.instance().numberOfPalantiri()){
            return true;
        }
        else{
