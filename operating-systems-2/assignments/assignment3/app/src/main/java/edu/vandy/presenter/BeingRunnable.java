...
public class BeingRunnable
    ...
    // @@ Something important is missing here: - DONE
    ...
    public static void reset() {
        // TODO -- you fill in here. - DONE
        flag = false;
        mGazingThreads = new AtomicInteger(0);
        mBeingCount = new AtomicInteger(0);
    }
    ...
    private void gazeIntoPalantir(int gazingIterations,
        ...
        for (;
            ...
            // TODO -- you fill in here.  Don't use - DONE
            // Thread.interrupted() here!
            // @@ This is the wrong way to check if the gazing is done. - DONE
            // Please look carefully at the methods you implemented above..
            if (isShutdown()) {
                Log.d(TAG,
