...
public class PalantiriManager {
     ...
     */
    // TODO -- you fill in here.  Ugrads use the Java Semaphore, - DONE
     ...
     */
    // TODO -- you fill in here.  Ugrads use a StampedLock, whereas - DONE
    ...
    public Palantir acquire() {
        ...
        try{
            Iterator<Palantir> it = mPalantiriMap.keySet().iterator();
            while(it.hasNext()){
                Palantir p = it.next();
                if(mPalantiriMap.get(p)){
                    ...
                    if(stamp != 0L) {
                        ...
                        //Someone else has started writing, start over
                        stamp = mStampedLock.readLock();
                        it = mPalantiriMap.keySet().iterator();
                    }
                }
            }
        }
    ...
    public void release(final Palantir palantir) {
        ...
        // TODO -- you fill in here.  Ugrads should use a StampedLock - DONE
